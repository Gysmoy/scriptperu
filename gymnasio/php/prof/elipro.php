...
<body style="background-color:#A4A3A3;">
    <form  name="frm-modificar" method="post" action="elipro.php?id=$cod" >
<?php
...
<div class="mx-2">
	<div class="form-row">
    	...
    	<div class="form-group col-md-4">
    	   <input type="text" class="form-control" name="text3" id="text3" disabled value="<?php echo $dir;?>">
    	</div>
    	</div>
    	<div class="form-row">
    	<div class="form-group col-md-2">
    	   <input type="text" class="form-control" name="text4" id="text4" disabled  value="<?php echo $cel;?>">
...
<?php
    ...
    else
    {
        ...
        $pdir=$_POST['text3'];
        $pcel=$_POST['text4'];
        $modi=("delete from profesor  where dni='$pdni'");
