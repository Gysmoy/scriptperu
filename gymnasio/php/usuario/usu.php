...
<form  name="frm_man" method="post" action="usu.php">
    <fieldset>
        ...
        <div class="mx-2">
            <div class="form-row">
                ...
                <div class="form-group col-md-4">
                    <input type="text" class="form-control" name="txnom" id="txnom" placeholder="Nombre">
                </div>
            </div>
        
        <div class="form-row">
            <div class="form-group col-md-2">
                <input type="text" class="form-control" name="txtlf" id="txtlf" placeholder="Login">
            </div>
            <div class="form-group col-md-2">
                <input type="password" class="form-control" name="txpes" id="txpes" placeholder="Password">
            </div>
            <div class="form-group col-md-2">
                <select name="txtal" size="1" id="txtal" class="form-control" placeholder="Tipo">
                    <option value="0" selected="selected">SeleccioneTipo</option>
...
<?php
    ...
    else
    {
        ...
        $pes=$_POST['txpes'];
        $tal=$_POST['txtal'];
        $var_consulta="insert into usuario (dni,nombre,login,pass,tipo) 
        values ('$cod','$ape','$cel','$pes','$tal')";
        $result= $db_connect -> query($var_consulta);   
        echo "<meta http-equiv='refresh' content='0,URL=usu.php' >";
    }
?>
</form>
<fieldset>
...
if ($result_prod -> num_rows > 0) {
    while ( $rows = $result_prod -> fetch_assoc() ) {
        ...
        <tr>
            ...
            <a href="edit/ediusu.php?id='.$doc.' "><img src="../../img/edit.png"  title="Editar" width=25 height=15></a>
            <a href="eliusu.php?id='.$doc.' "><img src="../../img/borrar.png"  title="Eliminar" width=25 height=15></a>
            </td>
